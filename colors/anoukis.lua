...
Group.new("Normal", c.fg, c.softPurple)
Group.new("InvNormal", c.softPurple, c.fg)
...
Group.new("IncSearch", c.softPurple, c.CursorLine:light())
...
-- Group.link("@constant.builtin", c.keyword)
...
Group.new("@variable.parameter", g.Parameter)
...
Group.new("@lsp.type.parameter", g.Parameter)
