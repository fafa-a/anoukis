...
Group.new("StatusLine", c.superwhite, c.lightGray)
Group.new("StatusLineNC", c.softPurple, c.lightGray)
...
Group.new("NotifyERRORBorder", c.deleted)
...
Group.new("NotifyINFOBorder", c.added)
Group.new("NotifyINFOIcon", c.added)
Group.new("NotifyINFOTitle", c.added, nil, s.italic)
Group.new("NotifyDEBUGBorder", c.orange)
Group.new("NotifyDEBUGIcon", c.orange)
Group.new("NotifyDEBUGTitle", c.orange, nil, s.italic)
Group.new("NotifyTRACEBorder", c.violet)
