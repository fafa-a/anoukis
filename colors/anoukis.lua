...
--
-- -- TODO work on design
-- Group.new("Pmenu", c.black, c.bgFloat, nil, nil, 0) -- Popup menu: normal item.
-- Group.new("PmenuSel", c.black, c.softPurple:dark()) -- Popup menu: selected item.
-- Group.new("PmenuSbar", c.error, c.lightGray) -- Popup menu: scrollbar.
-- Group.new("PmenuThumb", c.error, c.darkGray) -- Popup menu: Thumb of the scrollbar.
...
-- Group.new("WildMenu", nil, c.error) -- current match in 'wildmenu' completion
--
